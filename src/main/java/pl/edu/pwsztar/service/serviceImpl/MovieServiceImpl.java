...
import pl.edu.pwsztar.domain.mapper.CreateMovieListMapper;
...
public class MovieServiceImpl implements MovieService {
    ...
    public void createMovie(CreateMovieDto createMovieDto) {
        CreateMovieListMapper createMovieListMapper = new CreateMovieListMapper();
        movieRepository.save(createMovieListMapper.mapToEntity(createMovieDto));
    }
}
